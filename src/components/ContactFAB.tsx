  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      >
        ...
        {/* 호버시 라벨 */}
        <span className="absolute bottom-16 right-0 bg-gray-800 text-white px-3 py-1 rounded-lg text-sm font-medium shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap">
          GitHub
        </span>
      </a>
    </div>
